...
class AuthService {
  ...
  async register(userData) {
    try {
      ...
      await sendEmail({
        to: normalizedEmail,
        subject: 'Email Verification - Strangedev Systems',
        html: `
          <h2>Welcome to Strangedev Systems!</h2>
          ...
          <p>Best regards,<br>The Strangedev Systems Team</p>
        `
  ...
  async resendVerification(email) {
    try {
      ...
      await sendEmail({
        to: normalizedEmail,
        subject: 'Email Verification Code - Strangedev Systems',
        html: `
    ...
    try {
      ...
      try {
        const emailResult = await sendEmail({
          to: email,
          subject: 'Password Reset - Strangedev Systems',
          html: `
