...
const emailTemplates = {
  welcome: (userName) => ({
    subject: 'Welcome to Strangedev Systems!',
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        <h2 style="color: #2563eb;">Welcome to Strangedev Systems!</h2>
        <p>Hello ${userName},</p>
  ...
  passwordReset: (resetLink) => ({
    ...
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        ...
        <p>You requested a password reset for your Strangedev Systems account.</p>
